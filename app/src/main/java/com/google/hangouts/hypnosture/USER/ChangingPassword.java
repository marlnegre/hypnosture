            ...
            user.updatePassword(change.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        ...
                        mAuth.signOut();
                        finish();
                        startActivity(new Intent(ChangingPassword.this, MainActivity.class));
                    }
                    else{
                        Toast.makeText(ChangingPassword.this, "Your password cannot be changed!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
